...
o_csv["https-result-4c-monolake"].append(d_csv[12][0])
o_csv["https-result-4c-monolake"].append(d_csv[13][0])
o_csv["https-result-4c-monolake"].append(d_csv[14][0])
o_csv["https-result-4c-monolake"].append(d_csv[15][0])
o_csv["https-result-4c-monolake"].append(d_csv[12][1])
o_csv["https-result-4c-monolake"].append(d_csv[13][1])
o_csv["https-result-4c-monolake"].append(d_csv[14][1])
o_csv["https-result-4c-monolake"].append(d_csv[15][1])

o_csv["https-result-4c-nginx"].append("https-result-4c-nginx")
o_csv["https-result-4c-nginx"].append(d_csv[16][0])
o_csv["https-result-4c-nginx"].append(d_csv[17][0])
o_csv["https-result-4c-nginx"].append(d_csv[18][0])
o_csv["https-result-4c-nginx"].append(d_csv[19][0])
o_csv["https-result-4c-nginx"].append(d_csv[16][1])
o_csv["https-result-4c-nginx"].append(d_csv[17][1])
o_csv["https-result-4c-nginx"].append(d_csv[18][1])
o_csv["https-result-4c-nginx"].append(d_csv[19][1])

o_csv["https-result-4c-traefik"].append("https-result-4c-traefik")
o_csv["https-result-4c-traefik"].append(d_csv[20][0])
o_csv["https-result-4c-traefik"].append(d_csv[21][0])
o_csv["https-result-4c-traefik"].append(d_csv[22][0])
o_csv["https-result-4c-traefik"].append(d_csv[23][0])
o_csv["https-result-4c-traefik"].append(d_csv[20][1])
o_csv["https-result-4c-traefik"].append(d_csv[21][1])
o_csv["https-result-4c-traefik"].append(d_csv[22][1])
o_csv["https-result-4c-traefik"].append(d_csv[23][1])
