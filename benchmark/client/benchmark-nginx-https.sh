...
./wrk -d 1m -c 1447 -t 20 -R 27000 --latency https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server2 > https-result-4c-nginx-tiny.txt
./wrk -d 1m -c 1447 -t 20 -R 26000 --latency https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server3 > https-result-4c-nginx-small.txt
./wrk -d 1m -c 1447 -t 20 -R 23000 --latency https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server4 > https-result-4c-nginx-medium.txt
./wrk -d 1m -c 1000 -t 20 -R 4500 --latency https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server5 > https-result-4c-nginx-large.txt
