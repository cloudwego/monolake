...
./wrk -d 1m -c 10 -t 2 -R 2000 https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server2
./wrk -d 1m -c 10 -t 2 -R 2000 https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server3
./wrk -d 1m -c 10 -t 2 -R 2000 https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server4
./wrk -d 1m -c 10 -t 2 -R 2000 https://$MONOLAKE_BENCHMARK_PROXY_IP:8443/server5
