...
./wrk 'http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server2' -d 1m -c 10 -t 2; ./wrk 'http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server3' -d 1m -c 10 -t 2; ./wrk 'http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server4' -d 1m -c 10 -t 2; ./wrk 'http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server5' -d 1m -c 10 -t 2
