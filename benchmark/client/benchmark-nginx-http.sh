...
./wrk -d 1m -c 1447 -t 20 -R 31300 --latency http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server2 > http-result-4c-nginx-tiny.txt
./wrk -d 1m -c 1447 -t 20 -R 30000 --latency http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server3 > http-result-4c-nginx-small.txt
./wrk -d 1m -c 1447 -t 20 -R 28800 --latency http://$MONOLAKE_BENCHMARK_PROXY_IP:8100/server4 > http-result-4c-nginx-medium.txt
